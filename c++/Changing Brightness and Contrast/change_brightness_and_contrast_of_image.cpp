...
int main(int argc, char** argv)
{
    ...
    */
    ...
    Mat image_change_contrast_1, image_change_contrast_2, image_change_contrast_3, image_change_contrast_4;

    image.convertTo(image_change_contrast_1, -1,2,0);
    image.convertTo(image_change_contrast_2, -1,20,0);
    image.convertTo(image_change_contrast_3, -1,-10,0);
    image.convertTo(image_change_contrast_4, -1,100,0);
    
    namedWindow("Increased 2% contrast",WINDOW_AUTOSIZE);
    namedWindow("Increased 20% contrast",WINDOW_AUTOSIZE);
    namedWindow("Decreased -10% contrast",WINDOW_AUTOSIZE);
    namedWindow("Decreased 100% contrast",WINDOW_AUTOSIZE);
    
    imshow("Increased 2% contrast",image_brightness_50);
    imshow("Increased 20% contrast",image_brightness_100);
    imshow("Decreased -10% contrast",image_brightness_m_50);
    imshow("Decreased 100% contrast",image_brightness_m_100);
